...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  return (
    <button 
      ...
      {...props}
    >
      {loading && <Icons.Loader2 className="animate-spin -ml-1 mr-2 h-4 w-4" />}
...
export const Input: React.FC<InputProps> = ({ label, className = '', ...props }) => {
  return (
    <div className="w-full">
      ...
      <input 
        className={`w-full rounded-lg border-slate-300 border px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 shadow-sm outline-none transition-colors ${className}`}
        {...props}
      />
    </div>
  );
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        <textarea 
          className={`w-full min-h-[120px] rounded-lg border-slate-300 border px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 shadow-sm outline-none transition-colors resize-y ${className}`}
          {...props}
        />
      </div>
    </div>
